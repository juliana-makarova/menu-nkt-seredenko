...
// Компонент вкладки "Делители, ответвители"
export function DeliteliOtvetviteliTab({ scrollOffset, setScrollOffset }: { scrollOffset: number; setScrollOffset: (value: number) => void }) {
  ...
  return (
    <div className="absolute h-[971px] left-[246px] overflow-clip top-[146px] w-[1277px]">
      ...
      >
        <DeliteliOtvetviteliColumn3 />
      </motion.div>
    </div>
  );
}

// Колонка 1 делителей и ответвителей
function DeliteliOtvetviteliColumn1() {
  return (
    <>
      <Column title="СВЧ делители и ответвители" items={[
        "Подраздел 1",
        "Подраздел 2"
      ]} />
      <Column title="Направленные ответвители DAS" items={[
        "Подраздел 1",
        "Подраздел 2"
      ]} />
    </>
...
// Колонка 2 делителей и ответвителей
function DeliteliOtvetviteliColumn2() {
  return (
    <>
      <Column title="Ненаправленные ответвители (Тапперы)" items={[
        "Подраздел 1",
        "Подраздел 2"
      ]} />
      <Column title="Кольцевые и резистивные делители DA" items={[
        "Подраздел 1",
        "Подраздел 2"
      ]} />
    </>
...
// Колонка 3 делителей и ответвителей
function DeliteliOtvetviteliColumn3() {
  return (
    <>
      <Column title="Реактивные делители" items={[
        "Подраздел 1",
        "Подраздел 2"
      ]} />
    </>
