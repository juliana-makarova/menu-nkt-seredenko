  ...
  return (
    <div className="bg-white relative size-full overflow-hidden" data-name="Catalogue_comp">
      ...
      <div className="relative z-30">
        <MenuMain onProductsClick={() => setIsProductMenuOpen(!isProductMenuOpen)} isProductActive={isProductMenuOpen} />
      </div>
    </div>
  );
}
  ...
  return (
    <>
      <Column title="Кабели" items={[
        ...
        "Радиоизлучающие кабели, соединители, аксессуары",
        "Телекоммуникационные кабели SPUMA",
        "Кабели оптические",
        "Кбели электрические",
      ...
      <Column title="Кабельные сборки" items={[
        ...
        "Сборки на гофрированном кабеле"
      ]} />
  ...
  return (
    <>
      <Column title="Антенны" items={[
        ...
        "Радиоизлучающие кабели, соединители и аксессуары",
        "упорные антенны"
      ]} />
